...
module.exports.run = async(client, message, args) => {
    const embed = new Discord.RichEmbed()
        ...
        .addField('hola', 'Contesta con una frase', true)
        ...
        .addField('md', 'Manda un mensaje privado a si mismo o al miembro que se desee', true)
        .addField('digimons', 'Aparece un digimon random', true)
        .addField('di', 'Repite una frase que haya escrito el usuario', true)
        .addField('[Comandos en proceso] ', '[info, steam]', true)
